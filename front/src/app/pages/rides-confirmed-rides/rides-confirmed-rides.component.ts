...
export class RidesConfirmedRidesComponent implements OnInit {
  ...
  constructor(private ridesService: RidesService, private http: HttpClient, private sockServivce: SocketService, private driversService: DriversService, private messagingService: messageService,private ngbService: NgbModal) {
